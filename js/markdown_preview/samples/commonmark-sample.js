/**
 * CommonMark 0.31 Sample Content
 * Demonstrates CommonMark strict specification syntax
 */
export const COMMONMARK_SAMPLE = `# 1,3-Propanediol (1,3-PDO) Production via *Lactobacillus reuteri* CH53 (Fed-Batch Fermentation)
