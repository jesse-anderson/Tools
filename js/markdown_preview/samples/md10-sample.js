/**
 * Markdown 1.0 (Original/Gruber) Sample Content
 * Demonstrates original Markdown.pl syntax and features
 */
export const MD10_SAMPLE = `# 1,3-Propanediol (1,3-PDO) Production via *Lactobacillus reuteri* CH53 (Fed-Batch Fermentation)
