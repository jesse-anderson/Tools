/* @ts-self-types="./ai_image_detection_fft_wasm.d.ts" */
 ...
 */
export function compute_fft_2d(input, width, height) {
    const ret = wasm.compute_fft_2d(input, width, height);
    return ret;
}
 ...
 * @returns {Float32Array}
 */
export function compute_fft_2d_centered(input, width, height) {
    const ret = wasm.compute_fft_2d_centered(input, width, height);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ai_image_detection_fft_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ai_image_detection_fft_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
